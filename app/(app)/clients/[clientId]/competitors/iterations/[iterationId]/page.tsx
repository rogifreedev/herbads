...
import { getCompetitorIterationDetail, competitorIterationPerformanceLine, type CompetitorIteration } from "@/lib/competitor-iterations";
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            ...
            <Badge variant="secondary">{iteration.sourceCompetitorName}</Badge>
        ...
        <Card className="border-herb-border bg-herb-surface/90">
          ...
          <CardContent className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              {iteration.sourceCreativeSourceUrl ? (
                <Link href={iteration.sourceCreativeSourceUrl} target="_blank" className="block break-all text-sm text-white/55 hover:text-primary">
                  {iteration.sourceCreativeSourceUrl}
                </Link>
              ) : null}
...
function IterationSourcePreview({ iteration }: { iteration: CompetitorIteration }) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl bg-[radial-gradient(circle_at_top,rgba(229,31,118,0.22),transparent_42%),#1f2937]">
      {iteration.sourceCreativeVideoUrl ? (
        ...
        <div className="flex aspect-[4/5] items-center justify-center p-5">
